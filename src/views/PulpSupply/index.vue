      ...
      <div class="PulpSupply-head">
        ...
        >
          ...
          >
            ...
            <div class="suggest-content">{{ suggestion }}</div>
            <!-- <div v-if="suggestion.sg" class="suggest-content">
              <div>{{ suggestion.discript }}</div>
              <div class="list">
                <div v-for="(item,index) in suggestion.sg" :key="index">
                  {{ item }}
                </div>
              </div>
            </div>
            <div class="suggest-content" v-else>无</div> -->
          </div>
...
import { getOption, formatterCurveData } from '@/js/pulpSupply.js'
import {
  getDiagram,
  getSettings,
  postSettings,
    ...
    msg(value) {
      if (value) {
        ...
        if (
          ...
          // const suggest = {}
          // if (optimi.sg) {
          //   const sg = optimi.sg.replace(/pump/g, '').split(';')
          //   suggest.discript = '循环泵运行组合：'
          //   suggest.sg = sg
          // }
