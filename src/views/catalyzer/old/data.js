...
export const dict = {
  "smokeVolume": '烟气量(nm3/h)',
  "ammoniaAir": '氨空比',
  "outNoxConcentration": '出口Nox浓度(mg/Nm3)',
  "taskServiceTime": '服役时间',
  "active": '活性',
  "smokeTemperature": '烟气温度(°C)',
  "inNoxConcentration": '入口Nox浓度(mg/Nm3)',
  "ammoniaNitrogen": '氨氮比',
  "scrEfficiency": '脱硝效率(%)',
  "ammoniaInjection": '喷氨量(kg/h)'
}
      ...
      formatter(res) {
        ...
        res.forEach((item, idx) => {
          ...
          html += `
                    ...
                    ${item.seriesName}:${item.data || ""}${item.data.unit || ""}<br/>
                    `
